          ...
          <CardContent>
            ...
            {type === 'login' && (
              <div className="mt-6 p-4 bg-primary/10 border border-primary/20 rounded-lg">
                <p className="text-sm font-medium mb-2">💡 First time? Create an account or try these demo credentials:</p>
                ...
                <p className="text-xs text-muted-foreground mt-2">
                  Note: Demo accounts are created automatically. You can also create your own account!
                </p>
              </div>
            )}
