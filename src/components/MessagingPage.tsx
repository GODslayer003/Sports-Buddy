...
import { Send, Phone, Video, MoreVertical, Search, Users, Pin, ArrowLeft, Image, Smile, Paperclip } from 'lucide-react';
...
export function MessagingPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 h-[calc(100vh-5rem)]">
      <div className="flex h-full bg-background border rounded-lg overflow-hidden shadow-lg">
        {/* Chat List */}
        <div className={`w-full md:w-1/3 border-r flex-col ${selectedChat ? 'hidden md:flex' : 'flex'}`}>
        ...
        {/* Chat Area */}
        {selectedChat ? (
          <div className={`flex-1 flex-col w-full ${selectedChat ? 'flex' : 'hidden md:flex'}`}>
            {/* Chat Header */}
            ...
            {/* Messages */}
            <ScrollArea className="flex-1 p-4 bg-gradient-to-b from-muted/10 to-transparent">
