...
type Page = 'home' | 'login' | 'register' | 'events' | 'create-event' | 'matching' | 'admin' | 'profile' | 'messages' | 'achievements' | 'statistics' | 'event-detail' | 'notifications';
...
function AppContent() {
  ...
  const renderContent = () => {
    // Redirect logic
    if (!isAuthenticated && ['events', 'create-event', 'matching', 'admin', 'profile', 'messages', 'achievements', 'statistics', 'event-detail', 'notifications'].includes(currentPage)) {
